...
const Borderlands4 = () => {
  ...
  {
    date: "2024-01-15",
    title: "Borderlands 4 Beta Testing Phase Begins",
    description: "Join the closed beta and be among the first to experience the new weapon fusion system."
  },
  {
    date: "2024-01-08",
    title: "New Vault Hunter Classes Revealed",
    description: "Meet the four new Vault Hunters, each with unique skill trees and abilities."
  },
  {
    date: "2024-01-01",
    title: "Development Update: Visual Enhancements",
    description: "Behind-the-scenes look at the upgraded graphics engine and visual effects."
  }];
